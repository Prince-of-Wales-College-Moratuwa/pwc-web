...
$vocational1 = $_POST['vocational1'];
$vocational2 = $_POST['vocational2'];
$vocational3 = $_POST['vocational3'];
$vocational = $vocational1 . '/' . $vocational2 . '/' . $vocational3;
$school = $_POST['school'];
...
$fname = strtoupper(string: $_POST['fname']); 
$iname = strtoupper(string: $_POST['iname']);
