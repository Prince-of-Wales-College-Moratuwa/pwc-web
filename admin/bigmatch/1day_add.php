...
<div class="container-fluid py-4" style="min-height: 700px;">
	<h1>Add One Day Match</h1>


	<ol class="breadcrumb mt-4 mb-4 bg-light p-2 border">
		<li class="breadcrumb-item"><a href="index.php">Dashboard</a></li>
		<li class="breadcrumb-item active">Add One Day Match</li>
	</ol>
	...
	<div class="card mb-4">
		<div class="card-header">
			Add One Day Match (Add a "+" sign in front of the score for the team that batted first.)
		</div>
		<div class="card-body">
		...
		<div class="mt-4 mb-3 text-center">
			<input type="submit" name="add_1day" class="btn btn-success" value="Publish" />
		</div>
		</form>
	</div>
</div>
...
if (isset($_POST["add_1day"])) {
    ...
    $data = array(
        ...
        $query = "
        INSERT INTO bigmatch_1day_results 
        (result, year, pwc, ssc) 
        ...
        echo "<script>alert('Record added successfully'); window.location.href = '/admin/bigmatch/1day.php';</script>";
