	...
	<div class="dropdown">
		...
		<div class="dropdown-content">
			...
			<a class="nav-link <?php if ($page === 'principal-msg') echo 'active'; ?>"
				href="principal-msg.php?id=1"><img src="/admin/ion-icon/events.png" width="20px">&nbsp Principal's
				Msg</a>
			<a class="nav-link <?php if ($page === 'past-principals') echo 'active'; ?>" href="past-principals.php"><img
					src="/admin/ion-icon/events.png" width="20px">&nbsp Past Principals</a>
			<a class="nav-link <?php if ($page === 'school-admins') echo 'active'; ?>" href="school-admins.php"><img
					src="/admin/ion-icon/events.png" width="20px">&nbsp School Admins</a>
			<a class="nav-link <?php if ($page === 'prefects-topboard') echo 'active'; ?>"
				href="prefects-topboard.php"><img src="/admin/ion-icon/events.png" width="20px">&nbsp Prefect
				Topboard</a>
			<a class="nav-link <?php if ($page === 'past-prefects') echo 'active'; ?>" href="past-prefects.php"><img
					src="/admin/ion-icon/events.png" width="20px">&nbsp Past Headprefects</a>
			<a class="nav-link <?php if ($page === 'bigmatch') echo 'active'; ?>" href="bigmatch/bigmtach.php"><img
					src="/admin/ion-icon/events.png" width="20px">&nbsp Big Match</a>
