...
if(isset($_POST["add_event"]))
{
    ...
    $formdata['organizer_phone'] = trim($_POST["organizer_phone"]) ?: '077'; // Set default contact number if not provided
    ...
    if(move_uploaded_file($file_loc, $folder . $final_file)) {
        ...
        (title, date, time, location, organizer_name, organizer_phone, about, slug, img) 
        VALUES (:title, :date, :time, :location, :organizer_name, :organizer_phone, :about, :slug, '".$image."')
        ";
    }
