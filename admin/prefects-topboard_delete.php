...
if (isset($_GET["id"]) && is_numeric($_GET["id"])) {
    ...
    try {
        ...
        $sql_select = "SELECT img FROM about_prefect_topboard WHERE id = :id";
        ...
        $image_path = '../content/img/img-about/prefects/' . $image_name;
        ...
        $sql_delete = "DELETE FROM about_prefect_topboard WHERE id = :id";
