...
?>
    ...
    <meta name="keywords"
        content="prince of wales college contact, prince of wales college address, prince of wales college swimming pool bookings, prince of wales college email, prince of wales college location" />
...
<div class="container-xxl py-5">
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                <img class="img-fluid" src="content/img/img-contact/swimming-pool-pwc.webp" alt="PWC Swimming Pool"
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-12 wow fadeInUp" data-wow-delay="0.5s">
                <p class="mb-4">It is time to strengthen the Old Boys Association, let us all dedicate ourselves to
                    ...
                    Mater </p>
                <a class="btn btn-primary py-3 px-5 mt-2 wow zoomIn" target="_blank"
                    href="http://pwcoba.lk/member-registration/" data-wow-delay="0.7s">Enroll Now</a>
            </div>
        </div>
