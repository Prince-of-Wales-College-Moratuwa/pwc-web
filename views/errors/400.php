...
<body lang="en">
    ...
    <head>
        ...
        <link href="https://princeofwales.edu.lk/resources/lib/owlcarousel/assets/owl.carousel.min.css"
            rel="stylesheet">
    ...
    <div class="container text-center">
        <div class="row justify-content-center">
            <div class="col-lg-6">
                ...
                <h1 class="mb-4">Bad Request</h1>
                <p class="mb-4">Your browser sent a request that this server could not understand.</p>
